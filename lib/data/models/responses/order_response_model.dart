...
class OrderResponseModel {
  ...
  factory OrderResponseModel.fromJson(Map<String, dynamic> json) =>
      OrderResponseModel(
        ...
        availableQrCodes: List<AvailableQrCode>.from(
            json["available_qr_codes"].map((x) => AvailableQrCode.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "available_retail_outlets":
            List<dynamic>.from(availableRetailOutlets.map((x) => x.toJson())),
        "available_ewallets":
...
class AvailableBank {
  ...
  factory AvailableBank.fromRawJson(String str) =>
      AvailableBank.fromJson(json.decode(str));
...
enum AccountHolderName { JOHAN_BISNIS }

final accountHolderNameValues =
    EnumValues({"JOHAN BISNIS": AccountHolderName.JOHAN_BISNIS});
...
class AvailableDirectDebit {
  ...
  factory AvailableDirectDebit.fromRawJson(String str) =>
      AvailableDirectDebit.fromJson(json.decode(str));
...
class AvailableEwallet {
  ...
  factory AvailableEwallet.fromRawJson(String str) =>
      AvailableEwallet.fromJson(json.decode(str));
...
class AvailablePaylater {
  ...
  factory AvailablePaylater.fromRawJson(String str) =>
      AvailablePaylater.fromJson(json.decode(str));
...
class AvailableQrCode {
  ...
  factory AvailableQrCode.fromRawJson(String str) =>
      AvailableQrCode.fromJson(json.decode(str));
...
class AvailableRetailOutlet {
  ...
  factory AvailableRetailOutlet.fromRawJson(String str) =>
      AvailableRetailOutlet.fromJson(json.decode(str));
